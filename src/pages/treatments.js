...
export default () => (
  <Layout
    ...
    heroSubtitle={ <>At Picadilly Medical, <strong>Dr. Mowafak Abdelghani</strong> and his team are able to offer a variety of services ranging from simple treatments to more complex, x-ray and ultrasound-guided procedures targeted at the different causes of pain. .</> }>
    <XraySection />
    <UltrasoundSection />
    <SimpleSection />
  </Layout>
