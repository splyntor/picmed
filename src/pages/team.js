    ...
    <GridContainer justify="center">
      <GridItem xs={12} sm={12} md={6} >
        <ProfileCard
          ...
          title={<>{teamData.kurkar.title} {teamData.kurkar.fname} {teamData.kurkar.sname}</>}
      ...
      <GridItem xs={12} sm={12} md={6} >
        <ProfileCard
          ...
          title={<>{teamData.loughhead.title} {teamData.loughhead.fname} {teamData.loughhead.sname}</>}
    ...
    <GridContainer justify='center'>
      <GridItem xs={12} sm={12} md={6} >
        <ProfileCard
          ...
          title={<>{teamData.emma.title} {teamData.emma.fname} {teamData.emma.sname}</>}
